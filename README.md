...
In order to run tests, you will need to install pytest.  Also, in order to support tests of
Neo4j-implemented models, Neo4j-APOC should be running in a Docker container:
