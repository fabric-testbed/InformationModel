...
if __name__ == "__main__":
    ...
    gpu_worker = topo.add_node(name='gpuworker', model=worker_model, site=site,
                                    node_id='8CA64353-182D-4CF2-8A07-2ADFF7F9C42A',
                                    ntype=f.NodeType.Server, capacities=gpu_worker_cap)
    fastnet_worker = topo.add_node(name='fastnetworker', model=worker_model, site=site,
                                        node_id='B87900A2-5225-432A-92F8-60DD961597BE',
                                        ntype=f.NodeType.Server, capacities=network_worker_cap)
    slownet_worker = topo.add_node(name='slownetworker', model=worker_model, site=site,
    ...
    l10 = topo.add_link(name='l9', ltype=f.LinkType.DAC, layer=f.Layer.L2,
                             interfaces=[topo.nodes['slownetworker'].interfaces['nic5_p2'],
    ...
    l11 = topo.add_link(name='l10', ltype=f.LinkType.DAC, layer=f.Layer.L2,
                             interfaces=[topo.interfaces['nic6_p1'], switch.interfaces['p10']],
