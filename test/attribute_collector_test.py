...
class AttributeCollectorTest(unittest.TestCase):
    ...
    def testCollector(self):
        ...
        print(az)
        self.assertTrue('SmartNIC_ConnectX_6' in az.attributes[ResourceAuthZAttributes.RESOURCE_COMPONENT])
        self.assertTrue('SmartNIC_ConnectX_5' in az.attributes[ResourceAuthZAttributes.RESOURCE_COMPONENT])
        self.assertTrue('FPGA_Xilinx_U280' in az.attributes[ResourceAuthZAttributes.RESOURCE_COMPONENT])
        self.assertTrue('NVME_P4510' in az.attributes[ResourceAuthZAttributes.RESOURCE_COMPONENT])
